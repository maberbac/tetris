"""
Démonstration Plateau 6x6 avec Pièce T - Version avec Plateau Refactorisé
...
✅ Utilise le vrai Plateau(6, 6) au lieu de PlateauDemoT
...
class CommandeChuteRapideDemoT(Commande):
    """Commande de chute rapide pour la démo T."""
    
    def execute(self, moteur) -> bool:
        """Fait tomber la pièce T jusqu'en bas."""
...
class CommandeDeplacerGaucheDemoT(Commande):
    """Commande de déplacement gauche pour la démo T."""
...
class CommandeDeplacerDroiteDemoT(Commande):
    """Commande de déplacement droite pour la démo T."""
...
class CommandeTournerDemoT(Commande):
    """Commande de rotation pour la démo T."""
...
class MoteurDemo6x6TAvecPlateau:
    """
    Moteur pour la démonstration T utilisant le VRAI plateau refactorisé.
    ...
    def __init__(self):
        ...
        print(f"🎮 Moteur démo T 6x6 avec VRAI plateau initialisé")
...
class AffichageAvecPlateauT:
    """Affichage pour la démo T avec le vrai plateau."""
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("Demo 6x6 - Pièce T avec Plateau Refactorisé")
        
        # Couleurs
        self.noir = (0, 0, 0)
        self.gris = (64, 64, 64)
        self.blanc = (255, 255, 255)
        self.violet = (128, 0, 128)   # Violet pour pièce T active
    ...
    def dessiner(self, moteur: MoteurDemo6x6TAvecPlateau):
        ...
        # Titre
        titre = "Demo 6x6 - Pièce T avec Plateau Refactorisé"
...
class GestionnaireDemoTAvecPlateau(GestionnaireEvenements):
    """Gestionnaire d'événements pour la démo T avec vrai plateau."""
    
    def _creer_commandes(self):
        """Crée le mapping avec nos commandes pour la pièce T."""
        from src.domaine.services.commandes import (
            CommandeDescendre, CommandePause, CommandeAfficherMenu
        )
        
        return {
            ToucheClavier.GAUCHE: CommandeDeplacerGaucheDemoT(),
            ToucheClavier.DROITE: CommandeDeplacerDroiteDemoT(),
            ToucheClavier.ROTATION: CommandeTournerDemoT(),
            ToucheClavier.CHUTE_RAPIDE: CommandeDescendre(),
            ToucheClavier.CHUTE_INSTANTANEE: CommandeChuteRapideDemoT(),
            ToucheClavier.MENU: CommandeAfficherMenu(),
            ToucheClavier.PAUSE: CommandePause(),
        }


class DemoTAvecPlateauRefactorise:
    """Démonstration T utilisant le vrai plateau refactorisé."""
    
    def __init__(self):
        self.moteur = MoteurDemo6x6TAvecPlateau()
        self.affichage = AffichageAvecPlateauT()
        self.gestionnaire = GestionnaireDemoTAvecPlateau()
        ...
        print("🚀 Démonstration T avec plateau REFACTORISÉ initialisée !")
    ...
    def executer(self):
        ...
        print("\n=== DEMO T AVEC PLATEAU REFACTORISÉ ===")
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_RETURN:
                        ...
                        print("⏎ Pièce T placée manuellement")
        ...
        pygame.quit()
        print("\n✨ Démonstration T avec plateau refactorisé terminée.")
        print("🎯 Vous avez vu les bénéfices de la refactorisation en action !")


if __name__ == "__main__":
    print("🚀 Démarrage de la démonstration T avec plateau REFACTORISÉ...")
    print("🎯 Cette version montre les bénéfices concrets de la refactorisation !")
