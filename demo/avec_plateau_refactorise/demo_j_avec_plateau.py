"""
Démonstration Plateau 6x6 avec Pièce J - Version avec Plateau Refactorisé
...
✅ Utilise le vrai Plateau(6, 6) au lieu de PlateauDemoJ
...
class CommandeChuteRapideDemoJ(Commande):
    """Commande de chute rapide pour la démo J."""
    
    def execute(self, moteur) -> bool:
        """Fait tomber la pièce J jusqu'en bas."""
...
class CommandeDeplacerGaucheDemoJ(Commande):
    """Commande de déplacement gauche pour la démo J."""
...
class CommandeDeplacerDroiteDemoJ(Commande):
    """Commande de déplacement droite pour la démo J."""
...
class CommandeTournerDemoJ(Commande):
    """Commande de rotation pour la démo J."""
...
class MoteurDemo6x6JAvecPlateau:
    """
    Moteur pour la démonstration J utilisant le VRAI plateau refactorisé.
    ...
    def __init__(self):
        ...
        print(f"🎮 Moteur démo J 6x6 avec VRAI plateau initialisé")
...
class AffichageAvecPlateauJ:
    """Affichage pour la démo J avec le vrai plateau."""
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("Demo 6x6 - Pièce J avec Plateau Refactorisé")
        
        # Couleurs
        self.noir = (0, 0, 0)
        self.gris = (64, 64, 64)
        self.blanc = (255, 255, 255)
        self.bleu = (0, 0, 255)           # Bleu pour pièce J active
    ...
    def dessiner(self, moteur: MoteurDemo6x6JAvecPlateau):
        ...
        # Titre
        titre = "Demo 6x6 - Pièce J avec Plateau Refactorisé"
...
class GestionnaireDemoJAvecPlateau(GestionnaireEvenements):
    """Gestionnaire d'événements pour la démo J avec vrai plateau."""
    
    def _creer_commandes(self):
        """Crée le mapping avec nos commandes pour la pièce J."""
        from src.domaine.services.commandes import (
            CommandeDescendre, CommandePause, CommandeAfficherMenu
        )
        
        return {
            ToucheClavier.GAUCHE: CommandeDeplacerGaucheDemoJ(),
            ToucheClavier.DROITE: CommandeDeplacerDroiteDemoJ(),
            ToucheClavier.ROTATION: CommandeTournerDemoJ(),
            ToucheClavier.CHUTE_RAPIDE: CommandeDescendre(),
            ToucheClavier.CHUTE_INSTANTANEE: CommandeChuteRapideDemoJ(),
            ToucheClavier.MENU: CommandeAfficherMenu(),
            ToucheClavier.PAUSE: CommandePause(),
        }


class DemoJAvecPlateauRefactorise:
    """Démonstration J utilisant le vrai plateau refactorisé."""
    
    def __init__(self):
        self.moteur = MoteurDemo6x6JAvecPlateau()
        self.affichage = AffichageAvecPlateauJ()
        self.gestionnaire = GestionnaireDemoJAvecPlateau()
        ...
        print("🚀 Démonstration J avec plateau REFACTORISÉ initialisée !")
    ...
    def executer(self):
        ...
        print("\n=== DEMO J AVEC PLATEAU REFACTORISÉ ===")
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_RETURN:
                        ...
                        print("⏎ Pièce J placée manuellement")
        ...
        pygame.quit()
        print("\n✨ Démonstration J avec plateau refactorisé terminée.")
        print("🎯 Vous avez vu les bénéfices de la refactorisation en action !")


if __name__ == "__main__":
    print("🚀 Démarrage de la démonstration J avec plateau REFACTORISÉ...")
    print("🎯 Cette version montre les bénéfices concrets de la refactorisation !")
