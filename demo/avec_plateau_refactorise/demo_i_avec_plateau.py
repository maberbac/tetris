"""
Démonstration Plateau 6x6 avec Pièce I - Version avec Plateau Refactorisé
...
✅ Utilise le vrai Plateau(6, 6) au lieu de PlateauDemoI
...
class CommandeChuteRapideDemoI(Commande):
    """Commande de chute rapide pour la démo I."""
    
    def execute(self, moteur) -> bool:
        """Fait tomber la pièce I jusqu'en bas."""
...
class CommandeDeplacerGaucheDemoI(Commande):
    """Commande de déplacement gauche pour la démo I."""
...
class CommandeDeplacerDroiteDemoI(Commande):
    """Commande de déplacement droite pour la démo I."""
...
class CommandeTournerDemoI(Commande):
    """Commande de rotation pour la démo I."""
...
class MoteurDemo6x6IAvecPlateau:
    """
    Moteur pour la démonstration I utilisant le VRAI plateau refactorisé.
    ...
    def __init__(self):
        ...
        print(f"🎮 Moteur démo I 6x6 avec VRAI plateau initialisé")
...
class AffichageAvecPlateauI:
    """Affichage pour la démo I avec le vrai plateau."""
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("Demo 6x6 - Pièce I avec Plateau Refactorisé")
        
        # Couleurs
        self.noir = (0, 0, 0)
        self.gris = (64, 64, 64)
        self.blanc = (255, 255, 255)
        self.cyan = (0, 255, 255)      # Cyan pour pièce I active
        self.jaune = (255, 255, 0)     # Jaune pour pièces placées
    ...
    def dessiner(self, moteur: MoteurDemo6x6IAvecPlateau):
        ...
        # Titre
        titre = "Demo 6x6 - Pièce I avec Plateau Refactorisé"
...
class GestionnaireDemoIAvecPlateau(GestionnaireEvenements):
    """Gestionnaire d'événements pour la démo I avec vrai plateau."""
    
    def _creer_commandes(self):
        """Crée le mapping avec nos commandes pour la pièce I."""
        from src.domaine.services.commandes import (
            CommandeDescendre, CommandePause, CommandeAfficherMenu
        )
        
        return {
            ToucheClavier.GAUCHE: CommandeDeplacerGaucheDemoI(),
            ToucheClavier.DROITE: CommandeDeplacerDroiteDemoI(),
            ToucheClavier.ROTATION: CommandeTournerDemoI(),
            ToucheClavier.CHUTE_RAPIDE: CommandeDescendre(),
            ToucheClavier.CHUTE_INSTANTANEE: CommandeChuteRapideDemoI(),
            ToucheClavier.MENU: CommandeAfficherMenu(),
            ToucheClavier.PAUSE: CommandePause(),
        }


class DemoIAvecPlateauRefactorise:
    """Démonstration I utilisant le vrai plateau refactorisé."""
    
    def __init__(self):
        self.moteur = MoteurDemo6x6IAvecPlateau()
        self.affichage = AffichageAvecPlateauI()
        self.gestionnaire = GestionnaireDemoIAvecPlateau()
        ...
        print("🚀 Démonstration I avec plateau REFACTORISÉ initialisée !")
    ...
    def executer(self):
        ...
        print("\n=== DEMO I AVEC PLATEAU REFACTORISÉ ===")
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_RETURN:
                        ...
                        print("⏎ Pièce I placée manuellement")
        ...
        pygame.quit()
        print("\n✨ Démonstration I avec plateau refactorisé terminée.")
        print("🎯 Vous avez vu les bénéfices de la refactorisation en action !")


if __name__ == "__main__":
    print("🚀 Démarrage de la démonstration I avec plateau REFACTORISÉ...")
    print("🎯 Cette version montre les bénéfices concrets de la refactorisation !")
