"""
Démonstration Plateau 6x6 avec Pièce O - Version avec Plateau Refactorisé
...
✅ Utilise le vrai Plateau(6, 6) au lieu de PlateauDemoO
...
class CommandeChuteRapideDemoO(Commande):
    """Commande de chute rapide pour la démo O."""
    
    def execute(self, moteur) -> bool:
        """Fait tomber la pièce O jusqu'en bas."""
...
class CommandeDeplacerGaucheDemoO(Commande):
    """Commande de déplacement gauche pour la démo O."""
...
class CommandeDeplacerDroiteDemoO(Commande):
    """Commande de déplacement droite pour la démo O."""
...
class CommandeTournerDemoO(Commande):
    """Commande de rotation pour la démo O."""
    
    def execute(self, moteur) -> bool:
        """Fait tourner la pièce O si possible (même si elle ne change pas)."""
        piece = moteur.obtenir_piece_active()
        plateau = moteur.obtenir_plateau()
        ...
        if plateau.peut_placer_piece(piece):
            print(f"🔄 Rotation O → {piece.positions}")
            return True
        else:
            # Annuler la rotation
            piece.positions = positions_originales
...
class MoteurDemo6x6OAvecPlateau:
    """
    Moteur pour la démonstration O utilisant le VRAI plateau refactorisé.
    ...
    def __init__(self):
        ...
        print(f"🎮 Moteur démo O 6x6 avec VRAI plateau initialisé")
...
class AffichageAvecPlateauO:
    """Affichage pour la démo O avec le vrai plateau."""
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("Demo 6x6 - Pièce O avec Plateau Refactorisé")
        
        # Couleurs
        self.noir = (0, 0, 0)
        self.gris = (64, 64, 64)
        self.blanc = (255, 255, 255)
        self.jaune = (255, 255, 0)     # Jaune pour pièce O active
    ...
    def dessiner(self, moteur: MoteurDemo6x6OAvecPlateau):
        ...
        # Titre
        titre = "Demo 6x6 - Pièce O avec Plateau Refactorisé"
...
class GestionnaireDemoOAvecPlateau(GestionnaireEvenements):
    """Gestionnaire d'événements pour la démo O avec vrai plateau."""
    
    def _creer_commandes(self):
        """Crée le mapping avec nos commandes pour la pièce O."""
        from src.domaine.services.commandes import (
            CommandeDescendre, CommandePause, CommandeAfficherMenu
        )
        
        return {
            ToucheClavier.GAUCHE: CommandeDeplacerGaucheDemoO(),
            ToucheClavier.DROITE: CommandeDeplacerDroiteDemoO(),
            ToucheClavier.ROTATION: CommandeTournerDemoO(),
            ToucheClavier.CHUTE_RAPIDE: CommandeDescendre(),
            ToucheClavier.CHUTE_INSTANTANEE: CommandeChuteRapideDemoO(),
            ToucheClavier.MENU: CommandeAfficherMenu(),
            ToucheClavier.PAUSE: CommandePause(),
        }


class DemoOAvecPlateauRefactorise:
    """Démonstration O utilisant le vrai plateau refactorisé."""
    
    def __init__(self):
        self.moteur = MoteurDemo6x6OAvecPlateau()
        self.affichage = AffichageAvecPlateauO()
        self.gestionnaire = GestionnaireDemoOAvecPlateau()
        ...
        print("🚀 Démonstration O avec plateau REFACTORISÉ initialisée !")
    ...
    def executer(self):
        ...
        print("\n=== DEMO O AVEC PLATEAU REFACTORISÉ ===")
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_RETURN:
                        ...
                        print("⏎ Pièce O placée manuellement")
        ...
        pygame.quit()
        print("\n✨ Démonstration O avec plateau refactorisé terminée.")
        print("🎯 Vous avez vu les bénéfices de la refactorisation en action !")


if __name__ == "__main__":
    print("🚀 Démarrage de la démonstration O avec plateau REFACTORISÉ...")
    print("🎯 Cette version montre les bénéfices concrets de la refactorisation !")
