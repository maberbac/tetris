"""
Démonstration Plateau 6x6 avec Pièce S - Version avec Plateau Refactorisé
...
✅ Utilise le vrai Plateau(6, 6) au lieu de PlateauDemoS
...
class CommandeChuteRapideDemoS(Commande):
    """Commande de chute rapide pour la démo S."""
    
    def execute(self, moteur) -> bool:
        """Fait tomber la pièce S jusqu'en bas."""
...
class CommandeDeplacerGaucheDemoS(Commande):
    """Commande de déplacement gauche pour la démo S."""
...
class CommandeDeplacerDroiteDemoS(Commande):
    """Commande de déplacement droite pour la démo S."""
...
class CommandeTournerDemoS(Commande):
    """Commande de rotation pour la démo S."""
...
class MoteurDemo6x6SAvecPlateau:
    """
    Moteur pour la démonstration S utilisant le VRAI plateau refactorisé.
    ...
    def __init__(self):
        ...
        print(f"🎮 Moteur démo S 6x6 avec VRAI plateau initialisé")
...
class AffichageAvecPlateauS:
    """Affichage pour la démo S avec le vrai plateau."""
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("Demo 6x6 - Pièce S avec Plateau Refactorisé")
        
        # Couleurs
        self.noir = (0, 0, 0)
        self.gris = (64, 64, 64)
        self.blanc = (255, 255, 255)
        self.vert = (0, 255, 0)        # Vert pour pièce S active
        self.gris_place = (180, 180, 180)  # Gris pour pièces placées
        self.rouge = (255, 0, 0)       # Pour pause
        self.vert_menu = (0, 200, 0)   # Vert foncé pour menu
        
        # Police
        self.police = pygame.font.Font(None, 20)
        self.police_titre = pygame.font.Font(None, 24)
    
    def dessiner(self, moteur: MoteurDemo6x6SAvecPlateau):
        ...
        for pos in moteur.piece_active.positions:
            ...
            rect = pygame.Rect(x, y, self.taille_cellule, self.taille_cellule)
            pygame.draw.rect(self.ecran, self.vert, rect)
            pygame.draw.rect(self.ecran, self.blanc, rect, 2)
        ...
        # Titre
        titre = "Demo 6x6 - Pièce S avec Plateau Refactorisé"
        ...
        # État du jeu
        couleur_etat = self.rouge if moteur.en_pause else (self.vert_menu if moteur.afficher_menu else self.blanc)
...
class GestionnaireDemoSAvecPlateau(GestionnaireEvenements):
    """Gestionnaire d'événements pour la démo S avec vrai plateau."""
    
    def _creer_commandes(self):
        """Crée le mapping avec nos commandes pour la pièce S."""
        from src.domaine.services.commandes import (
            CommandeDescendre, CommandePause, CommandeAfficherMenu
        )
        
        return {
            ToucheClavier.GAUCHE: CommandeDeplacerGaucheDemoS(),
            ToucheClavier.DROITE: CommandeDeplacerDroiteDemoS(),
            ToucheClavier.ROTATION: CommandeTournerDemoS(),
            ToucheClavier.CHUTE_RAPIDE: CommandeDescendre(),
            ToucheClavier.CHUTE_INSTANTANEE: CommandeChuteRapideDemoS(),
            ToucheClavier.MENU: CommandeAfficherMenu(),
            ToucheClavier.PAUSE: CommandePause(),
        }


class DemoSAvecPlateauRefactorise:
    """Démonstration S utilisant le vrai plateau refactorisé."""
    
    def __init__(self):
        self.moteur = MoteurDemo6x6SAvecPlateau()
        self.affichage = AffichageAvecPlateauS()
        self.gestionnaire = GestionnaireDemoSAvecPlateau()
        ...
        print("🚀 Démonstration S avec plateau REFACTORISÉ initialisée !")
    ...
    def executer(self):
        ...
        print("\n=== DEMO S AVEC PLATEAU REFACTORISÉ ===")
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_RETURN:
                        ...
                        print("⏎ Pièce S placée manuellement")
        ...
        pygame.quit()
        print("\n✨ Démonstration S avec plateau refactorisé terminée.")
        print("🎯 Vous avez vu les bénéfices de la refactorisation en action !")


if __name__ == "__main__":
    print("🚀 Démarrage de la démonstration S avec plateau REFACTORISÉ...")
    print("🎯 Cette version montre les bénéfices concrets de la refactorisation !")
