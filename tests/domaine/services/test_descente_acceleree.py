...
class TestDescenteAcceleree:
    ...
    def test_moteur_a_methode_faire_descendre_piece(self):
        ...
        assert hasattr(self.moteur, 'faire_descendre_piece'), \
    ...
    def test_faire_descendre_piece_deplace_piece_vers_bas(self):
        ...
        if resultat:  # Si le mouvement a réussi
            assert position_y_apres == position_y_initiale + 1, \
    ...
    def test_commande_descendre_execute_sans_crash(self):
        ...
        try:
            ...
            pytest.fail(f"CommandeDescendre ne doit plus crasher: {e}")
    ...
    def test_descente_acceleree_integree(self):
        ...
        assert piece_finale is not None, "Une pièce doit toujours être active"
